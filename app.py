...
def reply():
    ...
    if bool(user) == False and bool(tutor) == False:
        ...
        if type == 1:
            ...
            res.message("Hi 🙋‍♀️ *Learner* 🕺\n\n You can choose from the following options below: 👍"
            "\n\n*Type*\n\n 1️⃣ *Tutor Search*\n 2️⃣ *Doubts*\n 3️⃣ *Help* ")
        elif type == 2:
            profile.insert_one({'number':number,'status':'tutor_main','messages':[]})
            res.message("Hi 🙋‍♀️ *Tutor* 🕺 \n\n For Tutor Registration please enter *information as required*\n\n 👉 *Please Enter Your Full Name*")
        else:
            res.message("Hi 🙋‍♀️ Welcome to *The Mathly* 🕺🙏.\n You can choose from the following options below:"
                        "\n\n*Type*\n\n 1️⃣ *Are you Looking For Tutor ??*\n 2️⃣ *You Want to Become Tutor ??*")
            return str(res)
        ...
        if user['status'] == 'main':
            ...
            if option == 1:
                ...
                res.message("*Please respond 🤷‍♀️ with valid option number*\n\n 👉 You can choose from the following options below:"
                "\n\n👉 *Type the Option Number*\n\n 1️⃣ *Tutor Search*\n 2️⃣ *Doubts*\n 3️⃣ *Help* ")
                return str(res)
             ...
             if option == 0:
                 ...
                 res.message("Excellent Choice 😎, Let's select the *Subject of your choice* \n\n*Type the Option Number*\n\n 1️⃣ *Maths*\n 2️⃣ *Science*\n 3️⃣ *English*\n 0️⃣ *Main Menu*\n 9️⃣ *Previous menu*")
             else:
             ...
             try:
                 ...
                 res.message("Please respond 🤷‍♀️ with valid option\n\n👉 *Type the Option Number as shown below*\n\n 1️⃣ *Maths*\n 2️⃣ *Science*\n 3️⃣ *English*\n 0️⃣ *Main Menu*\n 9️⃣ *Previous menu*")
                 return str(res)
             ...
             if option == 1:
                 ...
                 users.update_one({'number': number}, {"$set": {"status": "tutor_search"}})
                 res.message("*Hi Welcome back to the Mode of tutoring*\n\n👉 *Type the Option Number*\n\n 1️⃣ *Home Tutor*\n 2️⃣ *Online Class*\n 3️⃣ *Coaching Centre*\n 0️⃣ *Main Menu*\n 9️⃣ *Previous Menu*")
                 return str(res)
                 ...
                 return str(res)
             res.message("Awesome Choice 😎😎 Please Select the *Grade level*\n\n👉 *Type the Option Number* \n\n 1️⃣ *Class 1st to 5th std*\n 2️⃣ *Class 6th to 8th std*\n 3️⃣ *Class 9th to 10th std*\n 0️⃣ *Main Menu*\n 9️⃣ *Previous Menu*")

        elif user['status'] == 'Grade':
             try:
                 option = int(text)
             except:
                 res.message("Please respond 🤷‍♀️ with valid option, Select the *Grade level*\n\n 👉 *Type the Option Number* \n\n1️⃣ *Class 1st to 5th std*\n 2️⃣ *Class 6th to 8th std*\n 3️⃣ *Class 9th to 10th std*\n 0️⃣ *Main Menu*\n 9️⃣ *Previous Menu*")
                 return str(res)
             item = user['item']
             subject = user['Subject']
             if option == 1 and item !='Online Class':
                 users.update_one({'number':number},{"$set":{"Grade":"1st to 5th"}})
                 #res.message("Great You want tutor for *Class 1st to 5th std*")
                 res.message("Bingo 😎😎, Please enter the *area pin code* 🏡:\n\n👉 *Or Else Type *\n\n 0️⃣ *Main Menu*\n 9️⃣ *Previous menu*")
                 users.update_one({'number':number},{"$set":{"status":"final_confirmation_pin"}})
                 ...
                 users.update_one({'number': number}, {"$set": {"status": "Home Tutor"}})
                 res.message("Hi, Welcome back to *subject selection*\n\n👉 *Type the Option Number*\n\n 1️⃣ *Maths*\n 2️⃣ *Science*\n 3️⃣ *English*\n 0️⃣ *Main Menu*\n 9️⃣ *Previous menu*")

             elif option == 2 and item !='Online Class':
                 users.update_one({'number':number},{"$set":{"Grade":"6th to 8th"}})
                 res.message("Bingo 😎😎, Please enter the *area pin code* 🏡:\n\n👉 *Or Else Type *\n\n 0️⃣ *Main Menu*\n 9️⃣ *Previous menu*")
                 users.update_one({'number':number},{"$set":{"status":"final_confirmation_pin"}})
             elif option == 3 and item != 'Online Class':
                 users.update_one({'number':number},{"$set":{"Grade":"9th to 10th"}})
                 res.message("Bingo 😎😎, Please enter the *area pin code* 🏡:\n\n👉 *Or Else Type *\n\n 0️⃣ *Main Menu*\n 9️⃣ *Previous menu*")
                 users.update_one({'number':number},{"$set":{"status":"final_confirmation_pin"}})
             elif option == 1 and item =='Online Class':
                 users.update_one({'number': number}, {"$set": {"Grade": "1st to 5th"}})

                 res.message(f"Great😎😎You want to search tutor for *{subject}* ,as *{item}* and Grade as *1st to 5th*\n\n 👉If you want to proceed Type1️⃣\n️ 0️⃣ *Main Menu*\n 9️⃣ *Previous menu*  ")
                 users.update_one({'number': number}, {"$set": {"status": "Online"}})
             elif option ==2 and item =='Online Class':
                 users.update_one({'number': number}, {"$set": {"Grade": "6th to 8th"}})

                 res.message(f"Great😎😎You want to search tutor for *{subject}* ,as *{item}* and Grade as *6th to 8th*\n\n 👉want to proceed? Type 1️⃣\n️ 0️⃣ *Main Menu*\n 9️⃣ *Previous menu*  ")
                 users.update_one({'number': number}, {"$set": {"status": "Online"}})
             elif option == 3 and item == 'Online Class':
                 users.update_one({'number': number}, {"$set": {"Grade": "9th to 10th"}})

                 res.message(f"Great😎😎You want to search tutor for *{subject}* ,as *{item}* and Grade as *9th to 10th*\n\n 👉want to proceed? Type 1️⃣\n️ 0️⃣ *Main Menu*\n 9️⃣ *Previous menu*")
                 users.update_one({'number': number}, {"$set": {"status": "Online"}})

             else:
                 res.message("Please respond 🤷‍♀️ with valid option, Please Select the *Grade level*:\n\n 👉 *Type the Option Number*\n\n1️⃣ *Class 1st to 5th std*\n 2️⃣ *Class 6th to 8th std*\n 3️⃣ *Class 9th to 10th std*\n 0️⃣ *Main Menu*\n 9️⃣ *Previous menu*")
                 return str(res)
            ...
            try:
                ...
                res.message("Please enter valid option")
                return str(res)
            if option == 0:
                users.update_one({'number': number}, {"$set": {"status": "main"}})
                res.message("Hi Welcome back to *The Mathly* 🕺🙏\n\n👉 *Type the Option Number of Your Choice*\n\n*Type*\n\n 1️⃣ *Tutor Search*\n 2️⃣ *Doubts*\n 3️⃣ *Help*")
                ...
                users.update_one({'number': number}, {"$set": {"status": "Grade"}})
                res.message("Hi, Welcome Back Please Select the *Grade level*:\n\n👉 *Type the Option Number*\n\n 1️⃣ *Class 1st to 5th std*\n 2️⃣ *Class 6th to 8th std*\n 3️⃣ *Class 9th to 10th std*\n 0️⃣ *Main Menu*\n 9️⃣ *Previous Menu*")
                return str(res)
            elif option == 1:
                Subject = user['Subject']
                Grade = user['Grade']
                item = user['item']
                selected_profile = ''
                for data in profile.find({"$and": [{'Subject': Subject, 'Grade': Grade, 'item': item, 'verification': 'active'}]}):
                ...
                if selected_profile == '':
                   ...
                   selected_profil = profile.find_one({"$and": [{'Subject': Subject, 'Grade': Grade, 'item': item, 'verification': 'active'}]})
                   ...
                   users.update_one({'number': number}, {"$set": {"status": "next_online", 'counter': 1}})


        elif user['status'] == 'final_confirmation_pin':
            try:
                code = int(text)
            except:
                res.message("*Please enter valid area pin code:*")
                return str(res)
            users.update_one({'number': number}, {"$set": {"pin_code": code}})
            users.update_one({'number': number}, {"$set": {"status": 'pin code'}})
            res.message(f"Great😎😎You want to search tutor for *{user['Subject']}* , Grade *{user['Grade']}*,as *{user['item']}* with area pin code *{code}*\n\n 👉If you want to proceed Type 1️⃣ \n️ 0️⃣ *Main Menu*\n 9️⃣ *Previous menu*")
            ...
            if new_next == 1:
                ...
                count = user['counter']
                selected = ''
                for data in profile.find({"$and": [{'Subject': Subject, 'Grade': Grade, 'item': item}]}).skip(count).limit(1):
                    selected = data
                    res.message(f"Here we go *{selected['name']}* is great *{user['Subject']}* teacher for *{user['Grade']}*\n\n. *{selected['prof']}*\n\n.👉To connect with the tutor you can call:{selected['number']}\n\n👉 *Do you want to search more profiles??*\n\n Type 1️⃣ To search More Profiles\n\n Type 2️⃣ To Exit*")
                    count = count + 1;
                    print(count)
                users.update_one({'number': number}, {"$set": {"status": "next_online", 'counter': count}})
                if selected == '':
                    res.message("Thats it learner right now, no more tutors avaliable in your area \n\n 👉 Type *Hi* to start the search again\n\n")
        ...
        if tutor['status'] == 'tutor_main':
            ...
            if final == 0:
                ...
                res.message("Its okay !!! 😊👍\n\n 👉 *To start again follow the process once again with required information* \n\n 📔*So Lets Start the Process*\n\n 👉*Please Enter Your Full Name*")
